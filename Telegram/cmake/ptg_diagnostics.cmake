if (DESKTOP_APP_PRINT_LINK_FLAGS)
    ...
    foreach(_ptg_env_var LDFLAGS CFLAGS CXXFLAGS)
        if(DEFINED ENV{${_ptg_env_var}})
            set(_ptg_env_${_ptg_env_var} "$ENV{${_ptg_env_var}}")
        else()
            set(_ptg_env_${_ptg_env_var} "")
        endif()
    endforeach()
    unset(_ptg_env_var)
    ...
    message(STATUS "  ENV{LDFLAGS}                    = ${_ptg_env_LDFLAGS}")
    message(STATUS "  ENV{CFLAGS}                     = ${_ptg_env_CFLAGS}")
    message(STATUS "  ENV{CXXFLAGS}                   = ${_ptg_env_CXXFLAGS}")
    message(STATUS "")
