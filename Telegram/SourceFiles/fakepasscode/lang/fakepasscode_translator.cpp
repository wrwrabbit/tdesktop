...
namespace PTG
{
    ...
    constexpr LangRecord LangRuTranslation[] = {
        ...
        {"lng_clear_cache_on_lock_help", "При блокировке программы (автоматической и ручной) все закэишрованные медиафайлы будут удалены для всех аккаунтов. Папка Загрузки не будет очищена."},
        ...
        {"lng_enable_dod_cleaning_help", "Для удаления файлов используются специальные алгоритмы, которые не позволяют их востановить."},
        ...
        {"lng_delete_actions_help", "Все ложные пароли будут удалены. Эта настройка не совместима с сокрытием аккаунтов. Вы можете настроить аккаунты только на выход, если включена эта опция."},
        {"lng_delete_actions_confirm", "Эта настройка не совместима с сокрытием аккаунтов. Вы можете настроить аккаунты только на выход, если включена эта опция. Если вы нажмете продолжить - все аккаунты настроенные на сокрытие станут настроены на выход. Продолжить?."},
        ...
        {"lng_delete_actions_hidden_conflict_err", "Нельзя спрятать аккаунт если выбрана опция 'Удалить все действия'"},
        {0, nullptr}
    };
    ...
    constexpr LangRecord LangByTranslation[] = {
        ...
        {"lng_clear_cache_on_lock_help", "Усе закэшыраванныя медыя файлы будуць выдалены пры блакаванні Тэлеграма. Папка Загрузкі не будзе ачышчацца."},
        ...
        {"lng_delete_actions_hidden_conflict_err", "Нельга схаваць акаўнт калі выбрана опцыя 'Выдаліць усе дзеянні'"},
        {0, nullptr}
    };
