...
win:
    ...
    pacman -Syu --noconfirm mingw-w64-x86_64-perl mingw-w64-x86_64-nasm mingw-w64-x86_64-yasm mingw-w64-x86_64-ninja msys/make diffutils pkg-config gperf
...
win:
    ...
    cmake -A %WIN32X64% ^
        ...
        -DGPERF_EXECUTABLE=%ROOT_DIR%\\ThirdParty\\msys64\\usr\\bin\\gperf ^
        -DZLIB_FOUND=1 ^
